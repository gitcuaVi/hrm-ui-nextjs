...
const data: DataType = {
  ...
  profile: {
    about: [
      { "property": "Status", "value": "Đang làm việc", "icon": "mdi:check-circle-outline" },
      { "property": "Change", "value": "Hành chính nguyên ngày thứ 7", "icon": "mdi:update" },
      { "property": "Employee ID", "value": "TP00001", "icon": "mdi:card-account-details-outline" },
      { "property": "Full Name", "value": "John Doe", "icon": "mdi:account-outline" },
      { "property": "Date of Birth", "value": "01-10-2001", "icon": "mdi:calendar" },
      { "property": "Marital Status", "value": "Độc thân", "icon": "mdi:heart-outline" },
      { "property": "Ethnicity", "value": "Kinh", "icon": "mdi:earth" },
      { "property": "Religion", "value": "Không", "icon": "mdi:church-outline" },
      { "property": "Nationality", "value": "Việt Nam", "icon": "mdi:flag-outline" },
      { "property": "Card Type", "value": "Citizen ID", "icon": "mdi:card-account-details" },
      { "property": "Issue Date", "value": "02-01-1999", "icon": "mdi:calendar-clock" },
      { "property": "Place of Issue", "value": "TPHCM", "icon": "mdi:map-marker-outline" },
      { "property": "Card Number", "value": "01486161846", "icon": "mdi:numeric" },
      { "property": "Company", "value": "Công ty cổ phần T-Plus", "icon": "mdi:domain" },
      { "property": "Passport Issue Date", "value": "02-01-1999", "icon": "mdi:passport" },
      { "property": "Issued by", "value": "...", "icon": "mdi:account-tie" },
      { "property": "Passport Expiry Date", "value": "02-01-1999", "icon": "mdi:calendar-remove" },
      { "property": "Gender", "value": "Nam", "icon": "mdi:gender-male" }
    ],
    contacts: [
      { "property": "Phone Number", "value": "(123) 456-7890", "icon": "mdi:phone" },
      { "property": "Mobile Number", "value": "", "icon": "mdi:cellphone" },
      { "property": "Email", "value": "john.doe@example.com", "icon": "mdi:email" }
    ],
    probation: [
      { "property": "Probation Start Date", "value": "", "icon": "mdi:calendar-start", "color": "primary" },
      { "property": "Probation Period", "value": "", "icon": "mdi:clock-outline", "color": "info" },
      { "property": "Probation End Date", "value": "", "icon": "mdi:calendar-end", "color": "primary" },
      { "property": "Start Date", "value": "", "icon": "mdi:calendar-check", "color": "info" },
      { "property": "End Date", "value": "", "icon": "mdi:calendar-remove", "color": "primary" }
    ],
    health: [
      { "property": "Health", "value": "", "icon": "mdi:heart-pulse" },
      { "property": "Weight (kg)", "value": "", "icon": "mdi:scale-bathroom" },
      { "property": "Height (cm)", "value": "", "icon": "mdi:ruler" },
      { "property": "Notes", "value": "", "icon": "mdi:note-text-outline" }
    ],
    zalo: [
      { "property": "Zalo ID", "value": "", "icon": "mdi:account-key" },
      { "property": "Zalo Verify Code", "value": "", "icon": "mdi:key-outline" },
      { "property": "Zalo Verified", "value": "", "icon": "mdi:check-circle-outline" }
    ],
    connections: [
      {
        isFriend: false,
